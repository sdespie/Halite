...
def     choose_action(ship, game_map, me, nbr_drop) :
    ...
    #file.write("Ship ID = {}, Closest drop dist = {}, Other side = {}\n".format(ship.id, calc.get_closest_drop_dist(ship), (MAX_T - game.turn_number) * 1.1 + data.nbr_ships))
    if calc.get_closest_drop_dist(ship) * 1.3 > (MAX_T - game.turn_number) :
